$(function() {
     ...
     // Hovers
     $(".home_products_scroller_images li").mouseenter(function() {
...
var home_products = {
     ...
     move: function(dir) {
          ...
          if (this.animating == 1) {
               ...
               // Add _out class
               if (dir == "left") $(".home_products_scroller_images li._visible").first().addClass("_out");
               else $(".home_products_scroller_images li._visible").last().addClass("_out");
