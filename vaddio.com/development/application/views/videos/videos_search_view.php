            ...
            <div class="finder-section finder-section-1"> 
                <div class='text-area-wrapper'>
                    <div class='text-area-wrapper-inner'>
                        <input type="text" name="searchTerm" id="supportSearchInput" value="<?=$searchFor;?>" placeholder="Search" />
                    </div>
                </div>
...
<section class='leftCol'>
    ...
    <h3>Your search for <?= implode(" and ",$searchTermsDisplay); ?> returned <b><?= count($allVideos);?></b> results.</h3>
...
<script>
	...
	$(".content .video-list").highlight("<?= $s; ?>");
	<? } ?>
</script>
