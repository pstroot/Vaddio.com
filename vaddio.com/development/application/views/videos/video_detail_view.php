...
<? if (!isset($slug_not_found)){ ?>
    ...
    <h2 class="video-detail-name"><?= $video_name; ?></h2>
    
    <div class="videos-detail-graybox"><?= $video_output; ?></div>
        
    <div class="description">
        <?= $video_description; ?>
        <a href="<?=base_url();?>videos/all" class="rounded-corner-button orange-button">See All Videos</a>
    </div>

<? } else { ?>
	<h2>Sorry, we could not find the video you're looking for.</h2>
<? } ?>
